...
describe('DETETE /todos/:id', () => {
  ...
  it('should not remove todo doc without ownership', done => {
...
describe('PATCH /todos/:id', () => {
  it('should update the todo', done => {
    const hexId = todos[0]._id.toHexString();
    const text = 'This should be the text';
  ...
  it('should not update the todo without ownership', done => {
    const hexId = todos[0]._id.toHexString();
    const text = 'This should be the text';
...
describe('POST /users', () => {
  it('should create user', done => {
    const email = 'abc@yahoo.com';
    const password = '423432423dssfs';
    request(app)
      .post('/users')
      .send({ email, password })
      .expect(200)
  ...
  it('should not create user if email is in use', done => {
    const { email } = users[0];
    const password = '424535353533334';
    request(app)
      .post('/users')
      .send({ email, password })
      .expect(400)
